...
export default function CreateCampaignPage() {
  ...
  return (
    <div className="min-h-screen pt-28 pb-16 px-6 relative flex justify-center items-start overflow-hidden">
      ...
      <div className="max-w-xl w-full glass-card rounded-[2.5rem] p-8 mt-4 shadow-[0_0_40px_rgba(0,0,0,0.5)] relative overflow-hidden z-10">
        ...
        <h1 className="text-4xl font-black mb-2 relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-white">Start a Campaign</h1>
        <p className="text-gray-400 font-medium mb-8 border-b border-white/10 pb-6 relative z-10">Enter details to deploy your smart contract.</p>

        <div className="space-y-6 relative z-10">
          {/* CATEGORY SELECTION (NEW) */}
          <div>
            <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Campaign Category</label>
            <select
              className="w-full mt-1.5 p-4 bg-white/5 border border-white/10 rounded-2xl focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(0,245,255,0.2)] outline-none transition-all text-white backdrop-blur-md appearance-none"
              value={category}
          ...
          <div>
            <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Title</label>
            <input
              className="w-full mt-1.5 p-4 bg-white/5 border border-white/10 rounded-2xl focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(0,245,255,0.2)] outline-none transition-all text-white backdrop-blur-md"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Goal (ETH)</label>
              <input
                className="w-full mt-1.5 p-4 bg-white/5 border border-white/10 rounded-2xl focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(0,245,255,0.2)] outline-none transition-all text-white backdrop-blur-md"
                type="number"
                value={goal}
            ...
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Duration (Days)</label>
              <input
                className="w-full mt-1.5 p-4 bg-white/5 border border-white/10 rounded-2xl focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(0,245,255,0.2)] outline-none transition-all text-white backdrop-blur-md"
                type="number"
                value={duration}
          ...
          <div className="p-6 bg-white/5 border border-dashed border-white/20 rounded-3xl space-y-5 backdrop-blur-sm relative group hover:border-cyan-500/50 transition-colors">
            <h3 className="text-[10px] font-black tracking-widest text-cyan-400 uppercase">Identity Verification</h3>

            <select
              className="w-full p-4 bg-white/5 border border-white/10 rounded-2xl focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(0,245,255,0.2)] outline-none text-white appearance-none transition-all"
              value={govIdType}
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Upload Gov ID (PDF/PNG) *</label>
              <input
                type="file"
                className="block w-full text-sm text-gray-300 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-white/10 file:text-white hover:file:bg-white/20 hover:file:text-cyan-400 cursor-pointer transition-all border border-white/10 p-1.5 rounded-2xl"
                onChange={(e) => {
            ...
            <div className="space-y-1.5 mt-4">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-2">Upload Campaign Proof *</label>
              <input
                type="file"
                className="block w-full text-sm text-gray-300 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-white/10 file:text-white hover:file:bg-white/20 hover:file:text-cyan-400 cursor-pointer transition-all border border-white/10 p-1.5 rounded-2xl"
                onChange={(e) => {
          ...
          <button
            ...
            className="w-full mt-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-black py-4 rounded-2xl transition-all shadow-[0_0_20px_rgba(0,245,255,0.4)] hover:shadow-[0_0_30px_rgba(0,245,255,0.6)] hover:-translate-y-1 active:scale-[0.98] border border-cyan-400/50 uppercase tracking-[0.2em] text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Deploy Campaign
          </button>
        </div>
